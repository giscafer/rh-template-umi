...
class TagCloud extends Component<TagCloudProps, TagCloudState> {
  ...
  initTagCloud = () => {
    function getTextAttrs(cfg: { x?: any; y?: any; style?: any; opacity?: any; origin?: any; color?: any }) {
      return {
        ...cfg.style,
    ...
    (Shape as any).registerShape('point', 'cloud', {
      drawShape(cfg: { x: any; y: any }, container: { addShape: (arg0: string, arg1: { attrs: any }) => void }) {
