  ...
  <Row gutter={24}>
    <Col {...topColResponsiveProps}>
      <ChartCard
        ...
        footer={<Field label="日销售额" value={`￥${numberFormat().format(12423)}`} />}
        contentHeight={46}
      >
    ...
    <Col {...topColResponsiveProps}>
      <ChartCard
        ...
        total={numberFormat().format(8846)}
        footer={<Field label="日访问量" value={numberFormat().format(1234)} />}
        contentHeight={46}
      >
        <TinyArea
          height={46}
    ...
    <Col {...topColResponsiveProps}>
      <ChartCard
        ...
        total={numberFormat().format(6560)}
