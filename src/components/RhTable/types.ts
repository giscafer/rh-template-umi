...
// ExtraBtn type
type ExtraBtnAType = React.DetailedHTMLProps<React.AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>[];
...
export type RhTableProps<DataType, Params, ValueType> = ProTableProps<DataType, Params, ValueType> & RhTableSelfProps;

export type RhColumns<T = any, ValueType = 'text'> = ProColumns<T, ValueType> & {
  /**
   * 查询展示方式
   * @string 'query' | 'light'
   * @default 'query'
