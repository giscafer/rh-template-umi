...
function InputNumberRange({ form, separator, separatorWidth = 60, fieldProps, ...restProps }) {
 ...
 */
  ...
  return (
    <ProFormDigitRange separator={separator} separatorWidth={separatorWidth} {...restProps} fieldProps={fieldProps} />
  );
}
