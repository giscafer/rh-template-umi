...
test('formula:date', () => {
  expect(evalFormula('TIMESTAMP(DATE(2021, 11, 21, 0, 0, 0), "x")')).toBe(new Date(2021, 11, 21, 0, 0, 0).getTime());
  expect(evalFormula('DATETOSTR(DATE(2021, 11, 21, 0, 0, 0), "YYYY-MM-DD")')).toBe('2021-12-21');
  expect(evalFormula('DATETOSTR(DATE("2021-12-21"), "YYYY-MM-DD")')).toBe('2021-12-21');
  expect(evalFormula('DATETOSTR(TODAY(), "YYYY-MM-DD")')).toBe(moment().format('YYYY-MM-DD'));
  expect(evalFormula('DATETOSTR(NOW(), "YYYY-MM-DD")')).toBe(moment().format('YYYY-MM-DD'));
